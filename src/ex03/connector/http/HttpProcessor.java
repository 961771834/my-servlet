...
public class HttpProcessor {
    ...
    private Cookie[] parseCookieHeader(String header){
        ...
        while (header.length() > 0){
            int semiconlon = header.indexOf(";");
            if(semiconlon<0){
                semiconlon = header.length();
                if(semiconlon == 0){
                    break;
                }
                String token = header.substring(0,semiconlon);
                if(semiconlon< header.length())
                    header = header.substring(semiconlon+1);
                else
                    header = "";
                try {
